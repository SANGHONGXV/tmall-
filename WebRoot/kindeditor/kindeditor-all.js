...
/*
* 濡備綍瀹炵幇鐪熸鐨勮嚜鍔ㄩ珮搴︼紵
* 淇敼缂栬緫鍣ㄩ珮搴︿箣鍚庯紝鍐嶆鑾峰彇body鍐呭楂樺害鏃讹紝鏈�皬鍊煎彧浼氭槸褰撳墠iframe鐨勮缃珮搴︼紝杩欐牱灏卞鑷撮珮搴﹀彧澧炰笉鍑忋�
* 鎵�互姣忔鑾峰彇body鍐呭楂樺害涔嬪墠锛屽厛灏唅frame鐨勯珮搴﹂噸缃负鏈�皬楂樺害锛岃繖鏍峰氨鑳借幏鍙朾ody鐨勫疄闄呴珮搴︺�
* 鐢辨灏卞疄鐜颁簡鐪熸鐨勮嚜鍔ㄩ珮搴�* 娴嬭瘯锛歝hrome銆乫irefox銆両E9銆両E8
* */
/*******************************************************************************
* KindEditor - WYSIWYG HTML Editor for Internet
* Copyright (C) 2006-2011 kindsoft.net
...
KindEditor.plugin('flash', function(K) {
	...
	self.plugin.flash = {
		...
		'delete' : function() {
			...
			// [IE] 鍒犻櫎鍥剧墖鍚庣珛鍗崇偣鍑诲浘鐗囨寜閽嚭閿�			self.addBookmark();
		}
	};
	...
	self.plugin.table = {
		...
		rowmerge : function() {
			var table = self.plugin.getSelectedTable()[0],
				...
				nextRow = table.rows[nextRowIndex]; // 涓嬩竴琛�			// 鏈�悗涓�涓嶈兘鍚堝苟
		...
		coldelete : function() {
			...
			for (var i = 0, len = table.rows.length; i < len; i++) {
				...
				// 璺宠繃涓嶉渶瑕佸垹闄ょ殑琛�				if (newCell.rowSpan > 1) {
					i += newCell.rowSpan - 1;
				}
			}
